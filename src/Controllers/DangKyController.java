...
public class DangKyController implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Sign Up":
            ...
            if (username.isEmpty() || password.isEmpty() || hoTen.isEmpty() || address.isEmpty() || phoneNumber.isEmpty()) {
                ...
                try {
                    ...
                    if (quanLyTaiKhoan.SearchById(username) != null) {
                        JOptionPane.showMessageDialog(null, "Tên đăng nhập đã tồn tại!", "Error", JOptionPane.ERROR_MESSAGE);
                    } else {
                        TaiKhoan newAccount = new TaiKhoan(username, password, hoTen, address, phoneNumber);
                        quanLyTaiKhoan.Insert(newAccount);
                        JOptionPane.showMessageDialog(null, "Đăng ký tài khoản thành công!", "Success", JOptionPane.INFORMATION_MESSAGE);
